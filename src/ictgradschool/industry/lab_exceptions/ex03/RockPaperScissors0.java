 ...
 */
public class RockPaperScissors0 {
    ...
    private int getPlayerChoice(String playerName) {
        ...
        if (playerChoice.equalsIgnoreCase("rock") || Integer.parseInt(playerChoice) == ROCK) {
            return ROCK;
        } else if (playerChoice.equalsIgnoreCase("paper") || Integer.parseInt(playerChoice) == PAPER) {
            return PAPER;
        } else if (playerChoice.equalsIgnoreCase("SCISSORS") || Integer.parseInt(playerChoice) == SCISSORS) {
            return SCISSORS;
        } else if (playerChoice.equalsIgnoreCase("quit") || Integer.parseInt(playerChoice) == QUIT) {
            return QUIT;
        } else {
            return -1;
        }
    ...
    public static void main(String[] args) {
        ...
        RockPaperScissors0 ex = new RockPaperScissors0();
        ex.start();
